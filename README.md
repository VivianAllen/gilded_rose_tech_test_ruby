...
```
1: Added Test: #update_quality matches the golden master (no conjured objects)

Added golden_master module with prebuilt item arrays (one without conjured items,
one with conjured items, taken from texttest_fixture.rb, a golden master generator
method (generate_GM) and a sample of generate_GM's output from the original,
unrefactored gilded_rose class. Added test to ensure output of gilded rose update
quality does not deviate from this.
```
